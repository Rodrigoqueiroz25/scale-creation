...
import WeeklyMassScheduleIndexeddbGateway from "../infra/gateways/weekly-mass-schedule/weekly-mass-schedule-indexeddb.gateway";
import * as inspector from "node:inspector";

describe("test", () => {

    let repository: WeeklyMassScheduleIndexeddbGateway;
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        repository = new WeeklyMassScheduleIndexeddbGateway(idbAdapterMock);
    })
