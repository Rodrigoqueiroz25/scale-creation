...
import AltarServerListService from "../application/services/altar-server-list-service";
...
describe("AltarServerList", () => {
    ...
    let altarServerList: AltarServerListService;
    ...
    beforeEach(() => {
        ...
        altarServerList = new AltarServerListService(altarServersParoch, weeklyMassSchedule);
    })
